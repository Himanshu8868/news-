...
let url = `https://gnews.io/api/v4/search?q=example&lang=en&country=${country}=${category}&apikey=e247e269a7de788a9d43b532ba567f0c&page=${page}&pageSize=${pageSize}`;
  ...
  fetchMoreData = async () => {
    try {
      ...
      let url = `https://gnews.io/api/v4/search?q=example&lang=en&country=${country}=${category}&apikey=e247e269a7de788a9d43b532ba567f0c&page=${page + 1}&pageSize=${pageSize}`;

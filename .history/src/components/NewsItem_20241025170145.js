...
export class NewsItem extends Component {
  render() {
    let { title, description, Imageu, NewsUrl, author, date ,source } = this.props;
      ...
      <>
        <div>
          <div
            ...
            <img
              src={
                !Imageurl ? 'https://g.foolcdn.com/editorial/images/794361/golden-bull-and-bear-statues-in-front-of-a-global-map.jpg' : Image}

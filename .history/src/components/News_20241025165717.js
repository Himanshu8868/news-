...
export class News extends Component {
  ...
  async fetchNews(page) {
    try {
      ...
      apikey = 'e247e269a7de788a9d43b532ba567f0c';
let url = `https://gnews.io/api/v4/search?q=example&lang=en&country=${country}&max=10&apikey=e247e269a7de788a9d43b532ba567f0c&page=${page}&pageSize=${pageSize}`;
  ...
  fetchMoreData = async () => {
    try {
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apikey=e247e269a7de788a9d43b532ba567f0c&page=${
        page + 1
      }&pageSize=${pageSize}`;
